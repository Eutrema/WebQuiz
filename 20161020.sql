...
INSERT INTO `quiz` VALUES (1,'テスト問題です<br>答えは○',1,156,122,'○'),(2,'テスト問題です<br>答えは×',2,6,4,'×'),(3,'千円札に描かれている人物は野口英世である',1,1,1,'野口英世'),(4,'一万円札に描かれている人物は野口英世である',2,0,0,'福沢諭吉'),(5,'三角形の内角の和は180度である',1,1,1,'180度'),(6,'一番面積が小さい都道府県は香川県である',1,0,0,'香川県'),(7,'世界で一番多い血液型はA型である',2,1,1,'O型'),(8,'ゴールデンウィークの一番最初にやってくる祝日はこどもの日である',2,1,1,'憲法記念日'),(9,'ドイツの首都はロンドンである',2,1,0,'ベルリン'),(10,'イギリスの首都はロンドンである',1,1,1,'ロンドン'),(12,'千は0が3つ、億は0が8つ、兆は0が12個である',1,2,1,'12個'),(13,'アクアリウムとは水族館のことである',1,0,0,'水族館'),(14,'桃太郎がサルたちにあげたのは泥団子である',2,2,1,'きびだんご'),(15,'サイコロの1の反対側に書かれているのは6である',1,0,0,'6'),(16,'ホームページを閲覧するためのソフトはブラウザである',1,2,2,'ブラウザ'),(17,'2020年にオリンピックが行われるのは東京である',1,1,0,'東京'),(18,'ピカチュウの進化はライチュウである',1,0,0,'ライチュウ'),(19,'サザエさんにドラえもんは登場する',2,0,0,'登場しない'),(20,'干支(えと)に猫はいる',2,0,0,'いない'),(21,'東京ディズニーランドは東京都にある',2,1,0,'千葉県'),(22,'サッカーと野球、1チームの人数が多いのはサッカー',1,0,0,'サッカー'),(23,'100円玉と10円玉大きいのは100円玉',2,0,0,'10円玉'),(24,'大阪府枚方市の「枚方」は、「ひらかた」と読む',1,0,0,'ひらかた'),(25,'大阪府の府庁所在地は、枚方市である',2,0,0,'大阪市'),(26,'子どもの日は5月5日である',1,0,0,'こどもの日'),(27,'Tuesdayは木曜日である',2,0,0,'火曜日'),(28,'富士山は静岡県にある',1,0,0,'静岡県'),(29,'世界一硬いダイヤモンドはハンマーで叩いたら割れる',2,0,0,'割れる'),(30,'赤信号は渡ってはいけない',1,0,0,'渡ってはいけない');
...
-- Dump completed on 2016-10-20  2:58:38
